...
function PlaceOrder() {
  ...
  const { products,getCartCount,cartItems,setCartItems,getCartAmount,navigate,backendUrl,token,delivery_fee} = useContext(ShopContext)
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
          ...
          <div className='flex flex-col gap-4 w-full sm:max-w-[480px] '>
              ...
              <input required  onChange={onChangeHandler} name='email' value={formData.email} className='border border-gray-300 py-1.5 px-3.5 w-full' type="text" placeholder='Email Address' />
